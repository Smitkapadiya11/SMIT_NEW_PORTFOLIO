    ...
    <section className="relative flex min-h-screen flex-col justify-center overflow-hidden gradient-mesh">
      ...
      <div className="container-max relative z-10 px-6 pt-28 md:px-12 md:pt-36 lg:px-20">
        <div className="max-w-4xl">
          ...
          <motion.div {...fadeUp(0.1)} className="mb-6 flex flex-wrap gap-2">
          ...
          <motion.h1 {...fadeUp(0.15)} className="heading-xl mb-4 max-w-3xl">
      ...
      <motion.div {...fadeUp(0.9)} className="absolute bottom-8 left-1/2 z-10 -translate-x-1/2">
